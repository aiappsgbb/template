...
description: Azure Identity SDK for Python authentication. Use for DefaultAzureCredential, managed identity, service principals, and token caching. Triggers on azure-identity, DefaultAzureCredential, authentication, managed identity, service principal, credential.
