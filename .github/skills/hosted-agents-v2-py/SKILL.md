...
description: Build hosted agents using Azure AI Projects SDK with ImageBasedHostedAgentDefinition. Use when creating container-based agents that run custom code in Azure AI Foundry. Triggers on ImageBasedHostedAgentDefinition, hosted agent, container agent, create_version, ProtocolVersionRecord, AgentProtocol.RESPONSES.
