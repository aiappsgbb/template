...
**Skills**: Load `aigbb-azd-compliance` skill (or `azd-deployment` + `bicep-azd-patterns`) for current azd schema, Bicep conventions, and IMAGE_NAME/RESOURCE_EXISTS patterns.
