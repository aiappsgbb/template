...
- Dependencies with safe version pinning (no major version upgrades):
  - streamlit>=1.39.0,<2.0.0 (pin major version to prevent breaking changes)
...
- Data science dependencies:
  - pandas>=2.2.0,<3.0.0, numpy>=1.26.0,<2.0.0
  - plotly>=5.24.0,<6.0.0, altair>=5.4.0,<6.0.0
  - matplotlib>=3.9.0,<4.0.0, seaborn>=0.13.0,<0.14.0
- Optional AI dependencies:
  - openai>=1.51.0,<2.0.0, langchain>=0.3.0,<0.4.0
  - transformers>=4.45.0,<5.0.0, torch>=2.4.0,<3.0.0
  - pillow>=10.4.0,<11.0.0, scikit-learn>=1.5.0,<2.0.0
